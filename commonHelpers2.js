import{i as g}from"./assets/add-to-favorites-1912eddf.js";import{a as m,P as S,i as d}from"./assets/vendor-0a7c832e.js";const p={page:1,limit:1,filter:"Muscles"};function f(e){window.innerWidth>=1440?p.limit=9:p.limit=8,r.innerHTML="",x(e,p.page).then(t=>{t.results.length===0?(document.querySelector(".tui-pagination").style.display="none",r.innerHTML='<p class="ex-list-no-result">Unfortunately, <span class="accent-text">no results</span> were found. You may want to consider other search options to find the exercise you are looking for. Our range is wide and you have the opportunity to find more options that suit your needs.</p>'):(w(t.results),t.totalPages>1?(document.querySelector(".tui-pagination").style.display="flex",U(t.totalPages).on("afterMove",({page:s})=>{x(e,s).then(o=>{r.innerHTML="",w(o.results)})})):document.querySelector(".tui-pagination").style.display="none"),h("hide")}).catch(t=>{h("hide"),handleError(t.message)})}async function x(e,t){return h(),n.value.length>0?i.keyword=n.value.trim().toLowerCase():i.keyword="",(await m.get("/exercises",{params:{[e]:i.filterGroup,keyword:i.keyword,page:t,limit:p.limit}})).data}function w(e){let t=e.map(s=>`<li class="exercise-item js-id" data-id="${s._id}">
    ...
    </li>`).join("");r.innerHTML=t}function h(e="show"){const t=document.querySelector(".loader");e==="show"?t.style.display="inline-block":t.style.display="none"}const i={page:1,keyword:"",filter:"",filterGroup:""},r=document.querySelector(".gallery");r&&(r.addEventListener("click",O),r.classList.add("exercises-card"));const k=document.querySelector(".search-btn"),c=document.querySelector(".search-clear-btn"),n=document.querySelector(".search-input"),E=document.querySelector(".exercises-btns-div"),q=document.querySelector(".ex-search"),B=document.querySelector(".exercises-header");function O(e){if(e.preventDefault(),e.target.closest("ul").dataset.exercises){k.addEventListener("click",$),c.addEventListener("click",P),n.addEventListener("input",T),E.addEventListener("click",M),q.style.display="block";const t=document.querySelector(".exercises-button.active");i.filter=t.dataset.filter,i.filterGroup=e.target.closest("ul").dataset.exercises;const s=`Exercises / <span class="head-small">${i.filterGroup.charAt(0).toUpperCase()+i.filterGroup.slice(1)}</span>`;B.innerHTML=s,f(i.filter)}}function $(e){e.preventDefault(),n.value.length>0&&(i.page=1,i.keyword=n.value.trim().toLowerCase(),f(i.filter),n.value="",c.style.visibility="hidden")}function T(){n.value.length>0?c.style.visibility="visible":c.style.visibility="hidden"}function P(){n.value="",c.style.visibility="hidden",i.page=1,f(i.filter)}n.addEventListener("keypress",function(e){if(e.key==="Enter"){const t=n.value.trim().toLowerCase();i.keyword=t,c.style.visibility="hidden",i.page=1,f(i.filter),n.value=""}});function M(e){e.target.tagName==="BUTTON"&&(n.value="",q.style.display="none",r.innerHTML="",r.classList.remove("exercises-card"),k.removeEventListener("click",$),c.removeEventListener("click",P),n.removeEventListener("input",T),E.removeEventListener("click",M),i.page=1,B.innerHTML="Exercises")}function U(e){window.innerWidth>=1440?i.limit=9:i.limit=8;const t=document.querySelector(".tui-pagination"),s={totalItems:i.limit*e,itemsPerPage:i.limit,visiblePages:3,centerAlign:!0};return new S(t,s)}function A(e){window.innerWidth>=768?i.limit=12:i.limit=8;const t=document.querySelector(".tui-pagination"),s={totalItems:i.limit*e,itemsPerPage:i.limit,visiblePages:3,centerAlign:!0};return new S(t,s)}const a={gallery:document.querySelector(".gallery"),buttons:document.querySelector(".exercises-btns-div"),musclesBtn:document.querySelector('[data-filter="muscles"]'),bodypartsBtn:document.querySelector('[data-filter="bodypart"]'),equipBtn:document.querySelector('[data-filter="equipment"]')};m.defaults.baseURL="https://energyflow.b.goit.study/api";function G(e="show"){const t=document.querySelector(".loader");e==="show"?t.style.display="inline-block":t.style.display="none"}const l={page:1,limit:1,filter:"Muscles"};async function b(e){return G(),(await m.get("/filters",{params:{filter:l.filter,limit:l.limit,page:e}})).data}function j(e){d.error({position:"topRight",message:e})}function L(e){a.gallery.innerHTML="";const t=e.map(({name:s,filter:o,imgUrl:y})=>`<li class="gallery-item">
        <a href="">
