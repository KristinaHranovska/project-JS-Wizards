...
import { createMarkup } from './helper/helpers.js';
export { updateExercisesList, loadExercises };
  ...
  loadExercises(filter, params.page)
    .then(data => {
      if (data.results.length === 0) {
        ...
        const markup = createMarkup(data.results, codeWord, icons);
